@if ($pricingSection && $pricingSection->is_active)
    @php
        ...
        $defaultFeaturesTitle = $isVietnamese
            ? 'Tính năng chính'
            : 'Key Features';

        $sectionLabel = $isVietnamese
            ? 'Các gói social media'
            : 'Social media plans';
    @endphp

    <!-- Social media pricing start -->
    <section
        class="rts-pricing-area inner rts-section-gap"
                    ...
                    <div class="title-center-wrapper mb--30">
                        ...
                        @if ($pricingSection->title)
                            <h2
                                ...
                                class="title mb--0 rts-text-anime-style-1"
                            >
            ...
            @if (!empty($plans))
                <div class="row g-5 mt--10 justify-content-center">
                    ...
                    @foreach ($plans as $index => $plan)
                        @php
                            $planHeadingId = 'social-media-plan-' . $index;
                        @endphp

                        <div
                            class="{{ count($plans) === 2 ? 'col-xl-5' : 'col-xl-4' }} col-lg-6 col-md-6 col-12"
                        >
                            <article
                            ...
                            >
                                ...
                                @if (!empty($plan['features']))
                                    <div class="pricing-body">
                                        ...
                                        <div class="title">
                                            {{ $plan['features_title'] ?? $defaultFeaturesTitle }}
                                        </div>
