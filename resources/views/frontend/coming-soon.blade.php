...
<head>
    ...
    <title>
        {{ $isVi
            ? 'AI Reception Đang Được Xây Dựng | Senverse'
            : 'AI Reception Coming Soon | Senverse'
        }}
    </title>
        ...
        <div class="container">
            ...
            <div class="senverse-error-wrapper">
                ...
                <h2 class="senverse-error-title">
                    ...
                    {{ $isVi
                        ? 'AI Reception Đang Được Xây Dựng'
                        : 'AI Reception Is Coming Soon'
                    }}
                ...
                <p class="senverse-error-description">
                    ...
                    {{ $isVi
                        ? 'Chúng tôi đang phát triển AI Reception cho Senverse. Tính năng này sẽ sớm ra mắt để hỗ trợ nail salon trong quá trình tiếp nhận khách hàng.'
                        : 'We are building AI Reception for Senverse. This feature will be available soon to support nail salons with customer reception.'
                    }}
